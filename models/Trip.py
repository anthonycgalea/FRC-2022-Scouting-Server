...
class Trip:
    ...
    def getDirections(origin, dest):
        ...
        dist = tuple(
            [
                res_json["routes"][0]["summary"]["lengthInMeters"],
                res_json["routes"][0]["summary"]["travelTimeInSeconds"],
            ]
        )
    ...
    def _getWeather(loc):
        ...
        res_json = res.json()
        return (
            res_json["current"]["temperature"],
            res_json["current"]["weather_icons"][0],
        )
    ...
    def summary(self):
        ...
        print()
        print(
            f'Here is a summary of your trip from {details["src"]} to {details["dst"]}'
        )
        print()
        print(
            "{:<5}{:<{maxsrc}}{:<{maxdst}}{:>20}{:>{maxtime}}".format(
                "No.",
                "Origin",
                "Destination",
                "Distance (miles)",
